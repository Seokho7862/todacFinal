...
<body>
	...
	<script type="text/javascript">
		...
		var ICON_S = new daum.maps.MarkerImage(imageSrc, new daum.maps.Size(40, 30));
		var ICON_M = new daum.maps.MarkerImage(imageSrc, new daum.maps.Size(30, 20));
		var ICON_L = new daum.maps.MarkerImage(imageSrc, new daum.maps.Size(20, 15));
		...
		kakao.maps.event.addListener(map, 'idle', function() {
		    ...
		    if (1 <= level && level <= 3) {
		    	...
		    	alert(level);
		        markerImage = ICON_M;
		    } else if (6 <= level) { // 10레벨 이상에서도 마커이미지는 필요합니다. 예외처리 필요.
		    	alert(level);
		        markerImage = ICON_L;
		    }
		    var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize);
