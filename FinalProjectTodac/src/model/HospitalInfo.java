...
public class HospitalInfo {
	...
	private String dutyTime1c; //����ð� ������  ��
	private String dutyTime2c; //����ð� ȭ���� 
	private String dutyTime3c; //����ð� ������ 
	private String dutyTime4c; //����ð� ����� 
	private String dutyTime5c; //����ð� �ݿ��� 
	private String dutyTime6c; //����ð� ����� 
	private String dutyTime7c; //����ð� �Ͽ��� 
	private String dutyTime8c; //����ð� ������ 
	
	private String dutyTime1s; //����ð� ������ ����
	private String dutyTime2s; //����ð� ȭ����
	private String dutyTime3s; //����ð� ������
	private String dutyTime4s; //����ð� �����
	private String dutyTime5s; //����ð� �ݿ���
	private String dutyTime6s; //����ð� �����
	private String dutyTime7s; //����ð� �Ͽ���
	private String dutyTime8s; //����ð� ������
	
	private String dgidldName; //�������
	
	private double wgs84Lon; // �浵
